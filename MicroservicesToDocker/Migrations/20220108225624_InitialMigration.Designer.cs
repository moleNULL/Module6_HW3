...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MicroservicesToDocker.Data.Entities.CatalogItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MicroservicesToDocker.Data.Enums.CatalogBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MicroservicesToDocker.Data.Enums.CatalogType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MicroservicesToDocker.Data.Entities.CatalogItem", b =>
                {
                    b.HasOne("MicroservicesToDocker.Data.Enums.CatalogBrand", "CatalogBrand")
                        .WithMany()
                        .HasForeignKey("CatalogBrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MicroservicesToDocker.Data.Enums.CatalogType", "CatalogType")
                        .WithMany()
